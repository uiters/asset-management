        ...
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('Administration', '', 'flaticon-interface-8', '', [
                ...
                new AppMenuItem(
                    ...
                    'Pages.Administration.GroupAsset',
                    'flaticon-menu-1',
                    '/app/gwebsite/asset-group'
                ),
                new AppMenuItem(
                    'Quản lý loại tài sản',
                    'Pages.Administration.AssetType',
                    'flaticon-menu-1',
                    '/app/gwebsite/asset-type'
                ),
                new AppMenuItem(
                    'Quản Lý Sữa Chữa Tài Sản',
                    '',
                    'flaticon-menu-1',
                    '/app/gwebsite/fix-asset'
                ),
                new AppMenuItem(
                    'Quản Lý Đơn Vị Sử Dụng Tài Sản',
                    '',
                    'flaticon-menu-1',
                    '/app/gwebsite/unit'
                ),
                new AppMenuItem(
                    ...
                    'Pages.Administration.EvictionAsset',
                    'flaticon-menu-1',
                    '/app/gwebsite/eviction-asset'
                ),
                new AppMenuItem(
                    'Quản lý thanh lý tài sản',
                    'Pages.Administration.LiquidationAsset',
                    'flaticon-menu-1',
                    '/app/gwebsite/liquidation-asset'
                )
            ]),
