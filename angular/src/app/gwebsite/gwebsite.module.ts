...
import {
    ...
    CreateOrEditLiquidationAssetModalComponent,
    ViewLiquidationAssetModalComponent,
    EvictionAssetComponent,
    CreateOrEditEvictionAssetModalComponent,
    ViewEvictionAssetModalComponent
} from './index';
...
@NgModule({
    ...
    declarations: [
        ...
        CreateOrEditAssetModelComponent,
        AssetComponent,
        AssetGroupComponent,
        CreateOrEditAssetGroupModalComponent,
        ViewAssetGroupModalComponent,
        DepreciationComponent,
        CreateOrEditDepreciationModalComponent,
        AssetTypeComponent,
        CreateOrEditAssetTypeModalComponent,
        ViewAssetTypeModalComponent,
        FixAssetComponent,
        ...
        EvictionAssetComponent,
        ViewEvictionAssetModalComponent,
        CreateOrEditEvictionAssetModalComponent, ExportAssetComponent, CreateOrEditExportAssetModelComponent,
