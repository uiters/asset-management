...
import { CreateOrEditFixAssetModalComponent } from './create-or-edit-fixasset-modal.component';
...
export class FixAssetComponent extends AppComponentBase implements AfterViewInit, OnInit {

    /**
     * @ViewChild là dùng get control và call thuộc tính, functions của control đó
     */
    @ViewChild('textsTable') textsTable: ElementRef;
    @ViewChild('createOrEditModal') createOrEditModal: CreateOrEditFixAssetModalComponent;
    ...
    getMenuClients(event?: LazyLoadEvent) {
         ...
         */
        this._apiService.get('api/FixAsset/GetFixAssetsByFilter',
    ...
    applyFilters(): void {
        ...
        this._router.navigate(['app/gwebsite/fix-asset', {
